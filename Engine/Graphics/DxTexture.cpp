...
Graphics::DxTexure::DxTexure(const LPCWSTR filepath, ID3D11Device* device, ID3D11DeviceContext* context)
{
	m_bIsValid = false;
	m_texture = nullptr;
...
bool Graphics::DxTexure::IsValid()
{
	return m_bIsValid;
}

void Graphics::DxTexure::SetAsActive()
{
	if (!m_samplerState)
		CreateSamplerSate();
...
void Graphics::DxTexure::Initialize()
{
...
void Graphics::DxTexure::CreateSamplerSate()
{
