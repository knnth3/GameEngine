...
namespace Graphics
{
	namespace Model
	{
		...
		class Model3D
		{
			...
			friend class Graphics::DX11Graphics;
			friend class Graphics::TextInfo;
		public:
			AppDLL_API Model3D();
			...
			AppDLL_API void GetMeshData(std::vector<Graphics::Model::Vertex>& vertices, std::vector<uint32_t>& indices) const;
