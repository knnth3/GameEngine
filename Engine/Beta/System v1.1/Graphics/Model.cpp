...
void Graphics::Model::Set2DuvInfo(float length, float width, float xoffset, float yoffset)
{
	m_2DuvInfo = { length, width, xoffset, yoffset };
}
...
glm::vec4 Graphics::Model::Get2DuvInfo()
{
	return m_2DuvInfo;
}
...
void Graphics::Model::Initialize()
{
	...
	m_2DuvInfo = { 1.0f, 1.0f, 0.0f, 0.0f };
}
