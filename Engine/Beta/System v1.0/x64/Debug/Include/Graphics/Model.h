...
namespace Graphics
{
	...
	public:
		...
		GRAPHICS_DLL_API void SetRSS(RSS_STYLES style);
		...
		GRAPHICS_DLL_API RSS_STYLES GetRSS();
		GRAPHICS_DLL_API void UseViewMatrix(bool val);
		GRAPHICS_DLL_API bool IsUsingViewMatrix();
