...
bool Graphics::DX11DepthStencilState::Initialize()
{
	HRESULT result;
...
void Graphics::DX11DepthStencilState::OnWindowResize(ID3D11RenderTargetView* rtv, uint16_t windowWidth, uint16_t windowHeight)
{
	m_rtv = rtv;
	m_windowWidth = windowWidth;
	m_windowHeight = windowHeight;
...
void Graphics::DX11DepthStencilState::SetAsActive()
{
	m_context->OMSetRenderTargets(1, &m_rtv, m_depthStencilView);
	m_context->OMSetDepthStencilState(m_3DdepthStencilState, 1);
}

void Graphics::DX11DepthStencilState::ClearView()
{
	m_context->ClearDepthStencilView(m_depthStencilView, D3D11_CLEAR_DEPTH | D3D11_CLEAR_STENCIL, 1.0f, 0);		
}

void Graphics::DX11DepthStencilState::Close()
{
...
void Graphics::DX11DepthStencilState::SetDepthBufferStatus(const bool value)
{
	if (m_bBufferStatus != value)
	{
		m_bBufferStatus = value;
