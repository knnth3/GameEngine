...
namespace BinaryModelConverter
{
    ...
    partial ref class ConvertPage : public ::Windows::UI::Xaml::Controls::Page, 
    ...
    private:
        ...
        private: ::Windows::UI::Xaml::Controls::Grid^ SelectedFileInfo;
        private: ::Windows::UI::Xaml::Controls::Grid^ SelectedFolderInfo;
        private: ::Windows::UI::Xaml::Controls::Grid^ OutputLog;
